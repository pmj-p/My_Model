...
if __name__ == '__main__':
    #通过txt文件生成
    voc_data_dir="/media/amax/88b3d9ca-86d8-4859-98a6-8cbe052e5653/pmj/dataset/VOCdevkit/VOC2007"
    json_save_path="/media/amax/88b3d9ca-86d8-4859-98a6-8cbe052e5653/pmj/dataset/yixian_coco/annotation/test.json"
    parseXmlFiles_by_txt(voc_data_dir,json_save_path,"test1")   
