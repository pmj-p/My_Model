...
class EmbeddingRPNHead(BaseModule):
    ...
    def _decode_init_proposals(self, imgs, img_metas):
        ...
        imgs_whwh = torch.cat(imgs_whwh, dim=0) # [2 4]
        imgs_whwh = imgs_whwh[:, None, :]       # [2 1 4]
        ...
        init_proposal_features = self.init_proposal_features.weight.clone()  # [2 100 256]
        init_proposal_features = init_proposal_features[None].expand(        # 扩充维度num_imgs
