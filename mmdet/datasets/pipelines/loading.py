...
from .image_io_3DCE import load_multislice_png
...
@PIPELINES.register_module()
class LoadImageFromFile_3D:
    """Load mult-slice image from file.
    ...
    def __call__(self, results):
        ...
        if not self.lesion_input:            
            ...
            img = load_multislice_png(filename, self.num_slice, self.window)    
